    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-8 col-xs-offset-2">
          <nav class="pull">
            <ul class="top-nav">
              <li><a href="#intro"><i class="fa fa-mortar-board"></i><br><br>О нас</a></li>
              <li><a href="#features"><i class="fa fa-list"></i><br><br>Наши предложения</a></li>
              <li><a href="#responsive"><i class="fa fa-sitemap"></i><br><br>Почему Грузия</a></li>
              <li><a href="#portfolio"><i class="fa fa-bar-chart"></i><br><br>Лучшие предложения</a></li>
              <li><a href="#team"><i class="fa fa-child"></i><br><br>Наша команда</a></li>
              <li><a href="#contact"><i class="fa fa-eye"></i><br><br>Найти нас</a></li>
            </ul>
          </nav>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-8 col-md-offset-2 text-center inner">
          ...
          <p class="animated fadeInUp delay-05s">Страна круглогодичного отдыха</p>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6 col-md-offset-3 text-center">
          <a href="http://tympanus.net/codrops/?p=19439" class="learn-more-btn">Личный кабинет</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-md-offset-2 wp1">
        <h1 class="arrow">Что мы из себя представляем</h1>
        <p>Здесь должно быть крутое описание нашей компашки примерно на 3-5 строк.</p>
      </div>
    </div>
  </div>
</section>
      ...
      <div class="col-md-12">
        ...
        <div class="features-wrapper">
          <div class="col-md-4 wp2">
            ...
            <p>4 строки о том, как мы четко фильтруем отели, как подбираем их ИНДИВИДУАЛЬНО! и т.д. и т.п. ПС, подобрать иконку</p>
          </div>
          <div class="col-md-4 wp2 delay-05s">
            <div class="icon">
              <i class="fa fa-tree shadow"></i>
            </div>
            <h2>Резерв места на экскурсии</h2>
            <p>4 строки об интереснейших экскурсиях, чтоб мне аж самому захотелось туда поехать. Возможно "резерв места на экскурсию" чем-то заменим. ПС, подобрать иконку</p>
          </div>
          <div class="col-md-4 wp2 delay-1s">
            <div class="icon">
              <i class="fa fa-heart shadow"></i>
            </div>
            <h2>Безграничное удовольствие</h2>
            <p>4 строки о том, что мы можем сделать помимо первых двух пунктов, чтобы у людей не было слов кроме как shut up and take my money. ПС, иконка в принципе подходит для такого пункта</p>
          </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <ul class="social-buttons">
          ...
          <li><a href="#" class="social-btn"><i class="fa fa-twitter"></i></a></li>
          <li><a href="https://www.facebook.com/Welcome-to-Georgia-%D0%93%D1%80%D1%83%D0%B7%D0%B8%D1%8F-1643804892303688/" class="social-btn"><i class="fa fa-facebook"></i></a></li>
          <li><a href="https://www.instagram.com/welcome_to_georgia/" class="social-btn"><i class="fa fa-instagram"></i></a></li>
